...
import com.marcohc.architecture.rx.data.exception.NotHandledDataException;
 ...
 */
public abstract class BaseRxUseCase<M, E> implements RxUseCase<M> {
     ...
     */
    protected abstract void onDataException(@NonNull Throwable throwable) throws Throwable;
