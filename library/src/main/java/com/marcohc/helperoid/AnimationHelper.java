...
public class AnimationHelper {
    ...
    public static void startExpandAndCollapseWithRotationImage(final Context context, final View dropDownImage, final View collapsibleContainer, final View fadeContainer) {
        ...
        if (collapsibleContainer.getVisibility() == View.GONE) {
            ...
            AnimationListener listener = new AnimationListener() {
                ...
                @Override
                public void onAnimationEnd(Animation animation) {
                    AnimationHelper.startExpandViewAnimationOn(collapsibleContainer, fadeContainer);
                }
            };
            AnimationHelper.startRotateDownOn(context, dropDownImage, listener);
            ...
            AnimationListener listener = new AnimationListener() {
                ...
                @Override
                public void onAnimationEnd(Animation animation) {
                    AnimationHelper.startCollapseViewAnimationOn(collapsibleContainer, fadeContainer);
                }
            };
            AnimationHelper.startRotateUpOn(context, dropDownImage, listener);
    ...
    public static void startRotateDownOn(Context context, View view, AnimationListener listener) {
        Animation animation = AnimationUtils.loadAnimation(context, R.anim.rotate_down);
        if (listener != null) {
    ...
    public static void startRotateUpOn(Context context, View view, AnimationListener listener) {
        Animation animation = AnimationUtils.loadAnimation(context,R.anim.rotate_up);
        if (listener != null) {
            animation.setAnimationListener(listener);
        }
        view.startAnimation(animation);
